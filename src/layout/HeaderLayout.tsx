...
import { ModalCloseSession } from "../components/auth/ModalCloseSession";
...
export function HeaderLayout({ legalName, fullName }: HeaderLayoutProps) {
  ...
  const { showModal, confirmLogout, cancelAndContinue, secondsLeft } =
    useInactivityLogout();
